...
The B0 reference row of the pilot suite, reported in full: all eight rules (the four in the master table plus `changepoint`, `agent_first`, and the `relative_crossing` k-sweep), both GT settings, every pre-registered slice.
...
| agent_first | 0.262 [0.190, 0.341] | 0.183 [0.119, 0.246] | 0.362 [0.241, 0.483] | 0.086 [0.017, 0.172] |
...
| agent_first | 0.286 [0.214, 0.373] | 0.183 [0.119, 0.254] | 0.310 [0.190, 0.431] | 0.086 [0.017, 0.155] |
